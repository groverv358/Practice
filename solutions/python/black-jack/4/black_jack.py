...
def is_blackjack(card_one, card_two):
    ...
    card_one_is_ten = card_one in ('10', 'J', 'Q', 'K')
    card_two_is_ten = card_two in ('10', 'J', 'Q', 'K')
    if card_one_is_ace and card_two_is_ace:
        return False
    if card_one_is_ace:
        if card_two_is_ten:
            return True
...
def can_double_down(card_one, card_two):
    ...
    return bool(total_value >= 9 and total_value <= 11)
